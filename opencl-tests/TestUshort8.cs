...
namespace OpenCl.Tests
{
    ...
    public class TestUshort8
    {
        ...
        public void TestAdd()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_add");
        ...
        public void TestSub()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_sub");
        ...
        public void TestMul()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_mul");
        ...
        public void TestDiv()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_div");
        ...
        public void TestEq()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_eq");
        ...
        public void TestNeq()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_neq");
        ...
        public void TestLt()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_lt");
        ...
        public void TestLe()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_le");
        ...
        public void TestGt()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_gt");
        ...
        public void TestGe()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_ge");
        ...
        public void TestAnd()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_and");
        ...
        public void TestOr()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_or");
        ...
        public void TestXor()
        {
            ...
            // compile kernel
            var source = ClCompiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestUshort8", "test_ushort8_xor");

...
namespace OpenCl.Tests
{
    ...
    public class TestShort3
    {
        ...
        public void TestAndSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestShort3", "test_short3_and", module);
        ...
        public void TestOrSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestShort3", "test_short3_or", module);
        ...
        public void TestXorSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestShort3", "test_short3_xor", module);
        ...
        public void TestComponentAccessors1SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestShort3", "test_components1", module);
        ...
        public void TestComponentAccessors2SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestShort3", "test_components2", module);
        ...
        public void TestComponentAccessors3SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestShort3", "test_components3", module);

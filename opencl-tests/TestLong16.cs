...
namespace OpenCl.Tests
{
    ...
    public class TestLong16
    {
        ...
        public void TestAndSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong16", "test_long16_and", module);
        ...
        public void TestOrSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong16", "test_long16_or", module);
        ...
        public void TestXorSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong16", "test_long16_xor", module);

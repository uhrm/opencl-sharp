...
namespace OpenCl.Tests
{
    ...
    public class TestLong8
    {
        ...
        {
            var a = new long8[] { new long8((long)   7, (long)  14, (long)  21, (long)  28, (long)  35, (long)  42, (long)  49, (long)  56), new long8((long)   5, (long)  10, (long)  15, (long)  20, (long)  25, (long)  30, (long)  35, (long)  40) };
            var b = new long8[] { new long8((long)   5, (long)  10, (long)  15, (long)  20, (long)  25, (long)  30, (long)  35, (long)  40), new long8((long)   7, (long)  14, (long)  21, (long)  28, (long)  35, (long)  42, (long)  49, (long)  56) };
            var r = new long8[2];
        ...
        public void TestAddCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_add");
            ...
            using (var kernel = Kernel.CreateKernel(program, "test_long8_add"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
        ...
        public void TestAddSpirV()
        {
            ...
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_add", module);
        ...
        public void TestSubCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_sub");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_sub"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestSubSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_sub", module);
        ...
        public void TestMulCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_mul");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_mul"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestMulSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_mul", module);
        ...
        public void TestDivCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_div");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_div"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestDivSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_div", module);
        ...
        {
            var a = new long8[] { new long8((long)  14, (long)  13, (long)  12, (long)  11, (long)  10, (long)   9, (long)   8, (long)   7), new long8((long)   0, (long)   1, (long)   2, (long)   3, (long)   4, (long)   5, (long)   6, (long)   7) };
            var b = new long8[] { new long8((long)   0, (long)   1, (long)   2, (long)   3, (long)   4, (long)   5, (long)   6, (long)   7), new long8((long)  14, (long)  13, (long)  12, (long)  11, (long)  10, (long)   9, (long)   8, (long)   7) };
            var r = new long8[2];
        ...
        public void TestEqCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_eq");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_eq"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestEqSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_eq", module);
        ...
        public void TestNeqCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_neq");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_neq"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestNeqSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_neq", module);
        ...
        public void TestLtCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_lt");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_lt"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestLtSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_lt", module);
        ...
        public void TestLeCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_le");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_le"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestLeSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_le", module);
        ...
        public void TestGtCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_gt");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_gt"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestGtSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_gt", module);
        ...
        public void TestGeCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_ge");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_ge"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestGeSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_ge", module);
        ...
        public void TestAndCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_and");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_and"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestAndSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_and", module);
        ...
        public void TestOrCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_or");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_or"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestOrSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_or", module);
        ...
        public void TestXorCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_xor");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long8_xor"))
            using (var ma = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long8>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long8>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long8>()))
            {
        ...
        public void TestXorSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong8", "test_long8_xor", module);

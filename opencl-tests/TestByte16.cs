...
namespace OpenCl.Tests
{
    ...
    public class TestByte16
    {
        ...
        public void TestAdd()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_add");
        ...
        public void TestSub()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_sub");
        ...
        public void TestMul()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_mul");
        ...
        public void TestDiv()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_div");
        ...
        public void TestEq()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_eq");
        ...
        public void TestNeq()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_neq");
        ...
        public void TestLt()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_lt");
        ...
        public void TestLe()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_le");
        ...
        public void TestGt()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_gt");
        ...
        public void TestGe()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_ge");
        ...
        public void TestAnd()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_and");
        ...
        public void TestOr()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_or");
        ...
        public void TestXor()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte16", "test_byte16_xor");

...
namespace OpenCl.Tests
{
    ...
    public class TestByte4
    {
        ...
        public void TestAdd()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_add");
        ...
        public void TestSub()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_sub");
        ...
        public void TestMul()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_mul");
        ...
        public void TestDiv()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_div");
        ...
        public void TestEq()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_eq");
        ...
        public void TestNeq()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_neq");
        ...
        public void TestLt()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_lt");
        ...
        public void TestLe()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_le");
        ...
        public void TestGt()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_gt");
        ...
        public void TestGe()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_ge");
        ...
        public void TestAnd()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_and");
        ...
        public void TestOr()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_or");
        ...
        public void TestXor()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestByte4", "test_byte4_xor");

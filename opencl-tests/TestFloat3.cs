...
namespace OpenCl.Tests
{
    ...
    public class TestFloat3
    {
        ...
        public void TestComponentAccessors1SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestFloat3", "test_components1", module);
        ...
        public void TestComponentAccessors2SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestFloat3", "test_components2", module);
        ...
        public void TestComponentAccessors3SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestFloat3", "test_components3", module);

...
namespace OpenCl.Tests
{
    ...
    public class TestInt8
    {
        ...
        public void TestAndSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestInt8", "test_int8_and", module);
        ...
        public void TestOrSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestInt8", "test_int8_or", module);
        ...
        public void TestXorSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestInt8", "test_int8_xor", module);

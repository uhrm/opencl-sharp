...
namespace OpenCl.Tests
{
    ...
    public class TestInt8
    {
        ...
        public void TestAdd()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_add");
        ...
        public void TestSub()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_sub");
        ...
        public void TestMul()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_mul");
        ...
        public void TestDiv()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_div");
        ...
        public void TestEq()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_eq");
        ...
        public void TestNeq()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_neq");
        ...
        public void TestLt()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_lt");
        ...
        public void TestLe()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_le");
        ...
        public void TestGt()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_gt");
        ...
        public void TestGe()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_ge");
        ...
        public void TestAnd()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_and");
        ...
        public void TestOr()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_or");
        ...
        public void TestXor()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestInt8", "test_int8_xor");

...
namespace OpenCl.Tests
{
    ...
    public class TestUshort16
    {
        ...
        public void TestAndSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestUshort16", "test_ushort16_and", module);
        ...
        public void TestOrSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestUshort16", "test_ushort16_or", module);
        ...
        public void TestXorSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestUshort16", "test_ushort16_xor", module);

...
namespace OpenCl.Tests
{
    ...
    public class TestLong3
    {
        ...
        public void TestAdd()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_add");
        ...
        public void TestSub()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_sub");
        ...
        public void TestMul()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_mul");
        ...
        public void TestDiv()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_div");
        ...
        public void TestEq()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_eq");
        ...
        public void TestNeq()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_neq");
        ...
        public void TestLt()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_lt");
        ...
        public void TestLe()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_le");
        ...
        public void TestGt()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_gt");
        ...
        public void TestGe()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_ge");
        ...
        public void TestAnd()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_and");
        ...
        public void TestOr()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_or");
        ...
        public void TestXor()
        {
            ...
            // compile kernel
            var source = Compiler.EmitKernel("opencl-tests.dll", "OpenCl.Tests.TestLong3", "test_long3_xor");

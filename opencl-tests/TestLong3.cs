...
namespace OpenCl.Tests
{
    ...
    public class TestLong3
    {
        ...
        {
            var a = new long3[] { new long3((long)   7, (long)  14, (long)  21), new long3((long)   5, (long)  10, (long)  15) };
            var b = new long3[] { new long3((long)   5, (long)  10, (long)  15), new long3((long)   7, (long)  14, (long)  21) };
            var r = new long3[2];
        ...
        public void TestAddCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_add");
            ...
            using (var kernel = Kernel.CreateKernel(program, "test_long3_add"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
        ...
        public void TestAddSpirV()
        {
            ...
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_add", module);
        ...
        public void TestSubCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_sub");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_sub"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestSubSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_sub", module);
        ...
        public void TestMulCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_mul");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_mul"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestMulSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_mul", module);
        ...
        public void TestDivCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_div");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_div"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestDivSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_div", module);
        ...
        {
            var a = new long3[] { new long3((long)   4, (long)   3, (long)   2), new long3((long)   0, (long)   1, (long)   2) };
            var b = new long3[] { new long3((long)   0, (long)   1, (long)   2), new long3((long)   4, (long)   3, (long)   2) };
            var r = new long3[2];
        ...
        public void TestEqCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_eq");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_eq"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestEqSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_eq", module);
        ...
        public void TestNeqCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_neq");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_neq"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestNeqSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_neq", module);
        ...
        public void TestLtCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_lt");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_lt"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestLtSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_lt", module);
        ...
        public void TestLeCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_le");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_le"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestLeSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_le", module);
        ...
        public void TestGtCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_gt");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_gt"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestGtSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_gt", module);
        ...
        public void TestGeCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_ge");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_ge"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestGeSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_ge", module);
        ...
        public void TestAndCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_and");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_and"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestAndSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_and", module);
        ...
        public void TestOrCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_or");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_or"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestOrSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_or", module);
        ...
        public void TestXorCl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_xor");
            ...
            using (var queue = CommandQueue.CreateCommandQueue(context, device))
            using (var program = Program.CreateProgramWithSource(context, device, source))
            using (var kernel = Kernel.CreateKernel(program, "test_long3_xor"))
            using (var ma = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, a))
            using (var mb = Mem<long3>.CreateBuffer(context, MemFlags.ReadOnly | MemFlags.CopyHostPtr, b))
            using (var mr = Mem<long3>.CreateBuffer(context, MemFlags.ReadWrite, 2*Marshal.SizeOf<long3>()))
            {
        ...
        public void TestXorSpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_long3_xor", module);
        ...
        {
            var ar = new long3((long)1, (long)2, (long)3);
            var aw = (long)1;
            r[0] = ar.x;
            w[0].x = aw;
            r[1] = ar.y;
        ...
        public void TestComponentAccessors1Cl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_components1");
            ...
            using (var mw = Mem<long3>.CreateBuffer(context, MemFlags.WriteOnly, nw*Marshal.SizeOf<long3>()))
            {
                kernel.SetKernelArg(0, (HandleObject)mr);
                kernel.SetKernelArg(1, (HandleObject)mw);
                queue.EnqueueFillBuffer(mw, default(long3));
                queue.Finish();
        ...
        public void TestComponentAccessors1SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_components1", module);
        ...
        public void TestComponentAccessors2Cl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_components2");
        ...
        public void TestComponentAccessors2SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_components2", module);
        ...
        public void TestComponentAccessors3Cl()
        {
            ...
            // compile Cl kernel
            var source = ClCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_components3");
        ...
        public void TestComponentAccessors3SpirV()
        {
            ...
            // compile SPIR-V kernel
            var module = new MemoryStream();
            SpirCompiler.EmitKernel("opencl-tests", "OpenCl.Tests.TestLong3", "test_components3", module);
